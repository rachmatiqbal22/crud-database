...
if ($op == 'delete') {
    ...
    if ($q1) {
        ...
        $error = "Gagal melakukakan delete data";
    }
}
if ($op == 'edit') {
    $id = $_GET['id'];
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                if ($error) {
                    ...
                    <?php
                    header("refresh:3;url=index.php"); //proses penampilan 5detik
                }
                ?>
                <?php
                if ($sukses) {
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="index.php?op=edit&id=<?php echo $id ?>"> <button type="button"
                                            class="btn-danger">Edit</button>
                                    </a>
                                    <a href="index.php?op=delete&id=<?php echo $id ?>"
                                        onclick="return confirm('Delete data?')"> <button type="button"
